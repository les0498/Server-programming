...
<?php
	...
	$upfile_name	 = $_FILES["upfile"]["name"];  //koala.jpg
	$upfile_tmp_name = $_FILES["upfile"]["tmp_name"];  // 임시 저장된 파일 
	...
	$sql = "insert into board (id, name, category, subject, content, regist_day, hit,  file_name, file_type, file_copied) ";
	...
	echo "
	   <script>
	    location.href = 'bnotice_list.php';
	   </script>
	";
?>
